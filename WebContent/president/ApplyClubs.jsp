...
<Script Language="JavaScript">
    ...
    function ApplyClubNSH()
    {
    form1.action="/testclub/ApplyClubNSH";
    form1.submit();
    }
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         ...
	         <input type="hidden" name="search" value="enclub"/>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <c:forEach items="${ApplicationEnterClub }" var="U" varStatus="status">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td><input name="ope" type="hidden" value="${U.applicationNum}"/></td>
      	<td><input name="id" type="hidden" value="${U.applicationId}"/></td>
        <td align="center" valign="middle" class="borderbottom"><input  type="submit" value="通过" onClick="ApplyClubSH()" target="mainFrame" class="add" style=" font-size:12px; color:#548fc9;border:none;background:none;cursor:pointer;"><span class="gray">&nbsp;|&nbsp;</span><input  type="submit" value="不通过" onClick="ApplyClubNSH()" target="mainFrame" class="add" style=" font-size:12px; color:#548fc9;border:none;background:none;cursor:pointer;"></td>
		</form>
      </tr>
      <tr>
