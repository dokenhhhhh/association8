...
<Script Language="JavaScript">
    ...
    function ActivitySH()
    {
    	form1.action="/testclub/ActivitySH";
    	form1.submit();
    }
    
    function ActivityNSH()
    {
    	form1.action="/testclub/ActivityNSH";
    	form1.submit();
    }
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         ...
	         <input type="hidden" name="search" value="crclub"/>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <c:forEach items="${ApplicationAll }" var="U" varStatus="status">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td><input name="ope" type="hidden" value="${U.applicationResult}"/></td>
      	<td><input name="id" type="hidden" value="${U.applicationId}"/></td>
		<td align="center" valign="middle" class="borderbottom"><input  type="submit" value="通过" onClick="ActivitySH()" target="mainFrame" class="add" style=" font-size:12px; color:#548fc9;border:none;background:none;cursor:pointer;"><span class="gray">&nbsp;|&nbsp;</span><input  type="submit" value="不通过" onClick="ActivityNSH()" target="mainFrame" class="add" style=" font-size:12px; color:#548fc9;border:none;background:none;cursor:pointer;"></td>		
		</form>
      </tr>
      <tr>
      </c:forEach>
