    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form  action="/testclub/Search">
	         <span>社团：</span>
	         <input type="text" name="name" value="" class="text-word">
	         <input type="hidden" name="search" value="club"/>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">社团描述</th>
        <th align="center" valign="middle">操作</th>
      </tr>
      <c:forEach items="${ClubAll }" var="com" varStatus="status">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="center" valign="middle" class="borderright borderbottom">${status.index+1 }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${com.clubName}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${com.presidentnum}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${com.clubCreationTime}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${com.number}</td>
		<td align="center" valign="middle" class="borderright borderbottom">${com.clubContebt}</td>
