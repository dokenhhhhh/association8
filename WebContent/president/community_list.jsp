...
<Script Language="JavaScript">
    ...
    {
    form1.action="/testclub/ChangeMember";
    form1.submit();
    }
    
    function ApplyClubSH()
    {
    form1.action="/testclub/ApplyClubSH";
    form1.submit();
    }
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：社团管理&nbsp;&nbsp;>&nbsp;&nbsp;社团成员</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="post" action="/testclub/Search">
	         <span>成员：</span>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">入社时间</th>
        <th align="center" valign="middle">操作</th>
      </tr>
     
      <c:forEach items="${MemberAll }" var="member" varStatus="status">
      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${member.memberNum }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${member.memberName }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${member.post}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${member.memberPhone}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${member.enterTime}</td>
       <form action="/testclub/ChangeMember" name="form1">
      	<td><input name="id" type="hidden" value="${member.memberNum}"/></td>
        <td align="center" valign="middle" class="borderbottom"><input  type="submit" value="转让社长" onClick="ChangeMember()" target="mainFrame" class="add" style=" font-size:12px; color:#548fc9;border:none;background:none;cursor:pointer;"><span class="gray">&nbsp;|&nbsp;</span><input  type="submit" value="不通过" onClick="ApplyClubNSH()" target="mainFrame" class="add" style=" font-size:12px; color:#548fc9;border:none;background:none;cursor:pointer;"></td>
		</form>
      </tr>
      </c:forEach>
