...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="header">
  <tr>
    <td rowspan="2" align="left" valign="top" id="logo"><img src="images/yuanbiao.jpg" width="74" height="74"></td>
    <td align="left" valign="bottom">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="bottom" id="header-name">ZUCC社团管理</td>
        <td align="right" valign="top" id="header-right">
	        ...
	        <a href="../PwdChange.jsp" target="mainFrame" onFocus="this.blur()" class="admin-reset">修改密码</a>
            <a href="main.jsp" target="mainFrame" onFocus="this.blur()" class="admin-home">管理首页</a>
        	<a href="../homepage.html" target="_blank" onFocus="this.blur()" class="admin-index">网站首页</a>       	
            <span>
<!-- 日历 -->
